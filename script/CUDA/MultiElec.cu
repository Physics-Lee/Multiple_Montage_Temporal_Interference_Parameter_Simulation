...
void mexFunction(int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[])
{
    ...
    for (int i = 0; i<Nloop; i++){
        ...
        switch(alpha){
            case -1:
                MultiMaxKernel<<<gridSize, blockSize, sharedMemSize>>>(N128, d_e0, Nm, elecNumA, elecNumB, d_elecA, d_elecB, d_cuA, d_cuB, Mbase, d_r2);
                break;
            case 0:
                MultiVolumeKernel<<<gridSize, blockSize, sharedMemSize>>>(N128, d_e0, Nm, elecNumA, elecNumB, d_elecA, d_elecB, d_cuA, d_cuB, Mbase, d_volume, thres, d_r2);
                break;
            default:
                MultiAlphaKernel<<<gridSize, blockSize, sharedMemSize>>>(N128, d_e0, Nm, elecNumA, elecNumB, d_elecA, d_elecB, d_cuA, d_cuB, Mbase, d_volume, alpha, d_r2);
        }
